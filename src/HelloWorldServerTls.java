...
//        server = NettyServerBuilder.forAddress(new InetSocketAddress(host, port))
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("server crt : " + server.certChainFilePath);
        System.out.println("server key : " + server.privateKeyFilePath);
        System.out.println("server filePath : " + server.trustCertCollectionFilePath);
        server.start();
